...
action_bound = np.array([[-env.action_space.high[0], env.action_space.high[0]]]*3)  # 动作最大值
...
while not done:  # 测试回合
    action, u = agent.take_action(state, action_bounds=action_bound, explore=False)
